...
if AMSTENCIL:
    for monitor in monitors:
        for datatype in datatypes:
            ...
            avg_amstencil_error.to_csv("./error/motivation/amstencil_"+datatype+"_monitor"+str(monitor)+".csv",index=None)
#gram1
if GRAM1:
    for datatype in datatypes:
        ...
        avg_gram1_error.to_csv("./error/motivation/gram1_"+datatype+".csv",index=None)
...
if GRAM2:
    for datatype in datatypes:
        ...
        avg_gram2_error.to_csv("./error/motivation/gram2_"+datatype+".csv",index=None)
