...
const highprecision coefm=20.0,coefk=2.0,coefl=5.0,dvol=0.040,dvap=0.002,dsur=16,dgrb=1.6,dx=0.5,dy=0.5,dxdy=dx*dy,dtime=1.0e-4;
float R1=20,R2=R1/2;
float Ry1=240,Ry2=Ry1+R1+R2,Rx1=dimX/2+8;
const highprecision threshold=0.7;
const highprecision ratio=0.9;
